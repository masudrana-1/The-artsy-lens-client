...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-black text-white text-primary-content">
            <div>
                ...
                <p className="font-bold">
                    The Artsy Lens <br />Providing Best Professional Photography since 2015
                </p>
